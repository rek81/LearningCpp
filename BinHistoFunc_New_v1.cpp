...
public:
  ...
  TH2F *hist2;
  //  string type;
  BinHistoFunc_New(std::string histtype, std::string filename, std::string histname){
...
//BinHistoFunc_New obj =  BinHistoFunc_New("1D", "/home/rek81/userArea/CMSSW_10_2_2/src/trigger_turn_on/Final_for_Analysis_Note/SingleMuon/HTcut900/outputs/triggerRatePlots_RunE.root", "HTTrigNum");
